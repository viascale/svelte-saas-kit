                      ...
                      <div class="min-w-0 flex-1 px-4 md:grid md:grid-cols-2 md:gap-4">
                        <div>
                          <div class="flex items-end justify-between">
                            <div class="text-sm truncate font-bold text-gray-900 flex-grow">{item.providerWorkspace.name}</div>
                          </div>
                        </div>
                    ...
                    {#each sortedItems() as item}
                      <tr>
                        <td class="px-3 py-2 whitespace-nowrap">
                          <div class="text-sm font-extrabold text-gray-900">{item.providerWorkspace.name}</div>
                        </td>
                              ...
                              {#if item.contracts}
                                <span>
                                  ...
                                  {#if item.contracts.length === 1}
                                    <span>{$t("models.contract.object")}</span>
                                  {:else}
                                    <span>{$t("models.contract.plural")}</span>
                                  {/if}
                                </span>
                              {/if}
                            </Link>
