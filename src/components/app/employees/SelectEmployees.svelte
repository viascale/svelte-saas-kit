              ...
              <div class="max-w-lg mx-auto">
                <div>
                  <div class="text-center">
                    ...
                    <h2 class="mt-2 text-lg font-medium text-gray-900">{$t("app.employees.actions.selectEmployees")}</h2>
                ...
                <div class="mt-5">
                  <h3 class="text-xs font-semibold text-gray-500 uppercase tracking-wide">{$t("models.employee.plural")}</h3>
