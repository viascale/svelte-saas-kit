...
>
  ...
  />
  <rect x="375.66" y="136.55" width="199.84" height="47.27" transform="translate(-212.94 43.72) rotate(-12.11)" class="text-theme-700" />
  <path
  ...
  />
  <rect x="377.02" y="104.56" width="199.84" height="47.27" class="text-theme-700" />
  <path
