...
<div class="justify-center md:flex md:space-x-2 pt-5 px-3 mx-auto max-w-2xl">
  <h1 class="text-lg font-bold mx-auto mt-1 p-1 justify-center items-center flex w-full">{$t("shared.unauthorized")}</h1>
  <div class="max-w-md mx-auto px-4 lg:px-10 flex justify-center py-4 md:py-8 lg:py-12 rounded-sm text-center flex-col">
    <svg
    ...
    >
      ...
      <g opacity="0.1">
        ...
        <path d="M943,336.53h.55v-1.59s1.76-1.37,4.68,0v1.42h1v-.93h-.49s.2-1.93-3.06-1.62c0,0-2.62-.25-2.56,1.41h-.6Z" transform="translate(-26.97 -40.04)" />
      </g>
      <path
